    ...
    $.post('../api/albumImg',function(res){
        for (var key in res.schoolImg) {
            $(".my-gallery").append('<figure>'+
                '<a href="'+res.schoolImg[key]["imgSrc"]+'" data-size="1280x720">'+
                //'<img src="'+res[key]["imgSrc"]+'">'+
                ' <div id="i1" style="">'+
                '<div class="i2" style=""><img src="'+res.schoolImg[key]["imgSrc"]+'"></div>'+
                '<div class="picInfo" style="">'+res.schoolImg[key]["imgDescrib"]+'</div>'+
                '</div>'+
                '</a>'+
                '</figure>');
        }
